import { EOA_metadata } from './crypto/eoa/metadata.js'
import { UNISWAP_metadata } from './crypto/uniswap/metadata.js'
import { COINGECKO_metadata } from './crypto/coingecko/metadata.js'
import { DEFILLAMA_metadata } from './crypto/defillama/metadata.js'
import { BASE_metadata } from './crypto/base/metadata.js'
import { GNOSIS_metadata } from './crypto/gnosis/metadata.js'
import { ETHERSCAN_metadata } from './crypto/etherscan/metadata.js'
import { PNL_metadata } from './crypto/pnl/metadata.js'
import { SAFE_metadata } from './crypto/safe/metadata.js'
import { BLOCKSCOUT_metadata } from './crypto/blockscout/metadata.js'
import { AAVE_metadata } from './crypto/aave/metadata.js'
import { LENS_metadata } from './crypto/lens/metadata.js'
import { FARCASTER_metadata } from './crypto/farcaster/metadata.js'
import { FIREFLY_metadata } from './crypto/firefly/metadata.js'
import { Neynar_metadata } from './crypto/neynar/metadata.js'
