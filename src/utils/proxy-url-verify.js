...
[
    {
        urlPattern: 'api.etherscan.io',
        removeParams: ['apikey'], // Remove API key, let proxy handle it
        useProxy: true,
    },
    {
        urlPattern: 'api.basescan.org',
        removeParams: ['apikey'], // Remove API key, let proxy handle it
        useProxy: true,
    },
    {
        urlPattern: 'api.gnosisscan.io',
        removeParams: ['apikey'], // Remove API key, let proxy handle it
        useProxy: true,
    },
    {
    ...
    {
        urlPattern: 'openapi.firefly.land',
        useProxy: true,
        removeParams: ['apikey'],
    },
    {
        urlPattern: 'api.neynar.com',
        useProxy: true,
        removeParams: ['api_key'], // Remove API key, let proxy handle it
    },
    {
        urlPattern: 'api.safe.global',
        useProxy: true,
    },
    {
        urlPattern: 'api.llama.fi',
        useProxy: true,
    },
    {
        urlPattern: 'yields.llama.fi',
        useProxy: true,
    },
];
